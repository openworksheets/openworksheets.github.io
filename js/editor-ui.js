  ...
  return new Promise(resolve => {
    const dlg = el('dialog', { class: 'crypto-dialog' },
      el('form', { method: 'dialog' },
        ...
        el('label', { class: 'f-label', for: 'cifrarClave' }, t('crypto.exportPasswordLabel')),
        el('div', { class: 'password-row' },
          el('input', { type: 'password', id: 'cifrarClave', autocomplete: 'new-password', required: '' }),
          pwToggleBtn(t('crypto.showPassword'))),
        el('label', { class: 'f-label', for: 'cifrarClave2' }, t('crypto.exportPasswordRepeatLabel')),
        el('div', { class: 'password-row' },
          el('input', { type: 'password', id: 'cifrarClave2', autocomplete: 'new-password', required: '' }),
          pwToggleBtn(t('crypto.showPassword'))),
